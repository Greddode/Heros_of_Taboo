...
static const EquipData EQUIP_TABLE[EQUIP_COUNT] = {
    // NONE
    { EQUIP_NONE,           "", "", NULL,                            EQUIP_CAT_ARMOR,    EQUIP_SLOT_HEAD,     0, 0, 0, 0,0,0,0,0, false, false },

    // Armor - Head
    { EQUIP_LEATHER_CAP,    "Leather Cap",     "A simple leather cap.\n+1 DEF, +1 CON",       "resources/sprites/items/equipment/armors/leather_cap.png",    EQUIP_CAT_ARMOR, EQUIP_SLOT_HEAD, 0, 1, 0, 0,0,0,1,0, false, false },
    { EQUIP_IRON_HELM,      "Iron Helm",       "An iron helmet forged for battle.\n+2 DEF, +2 CON", "resources/sprites/items/equipment/armors/iron_helm.png",      EQUIP_CAT_ARMOR, EQUIP_SLOT_HEAD, 0, 2, 0, 0,0,0,2,0, false, false },
    ...
    // Weapons
    { EQUIP_SURVIVAL_KNIFE,"Survival Knife",   "A trusty blade for the dungeon.\n+2 ATK",     "resources/sprites/items/equipment/weapons/survival_knife.png", EQUIP_CAT_WEAPON, EQUIP_SLOT_WEAPON, 2, 0, 0, 0,0,0,0,0, false, false },
    { EQUIP_DAGGER,         "Dagger",          "A swift dagger.\n+3 ATK, +1 DEX",              "resources/sprites/items/equipment/weapons/dagger.png",         EQUIP_CAT_WEAPON, EQUIP_SLOT_WEAPON, 3, 0, 0, 0,1,0,0,0, false, false },
    { EQUIP_IRON_SWORD,     "Iron Sword",      "A well-balanced iron blade.\n+5 ATK",        "resources/sprites/items/equipment/weapons/iron_sword.png",    EQUIP_CAT_WEAPON, EQUIP_SLOT_WEAPON, 5, 0, 0, 0,0,0,0,0, false, false },
    { EQUIP_STEEL_SWORD,    "Steel Sword",     "A razor-sharp steel longsword.\n+8 ATK",     "resources/sprites/items/equipment/weapons/steel_sword.png",   EQUIP_CAT_WEAPON, EQUIP_SLOT_WEAPON, 8, 0, 0, 0,0,0,0,0, false, false },
    ...
    // Accessories
    { EQUIP_RING_OF_STRENGTH,  "Ring of Strength",   "A ring pulsing with power.\n+3 STR",           "resources/sprites/items/equipment/accessories/ring_of_strength.png", EQUIP_CAT_ACCESSORY, EQUIP_SLOT_ACCESSORY, 0, 0, 0, 3,0,0,0,0, false, false },
    { EQUIP_AMULET_OF_WARDING, "Amulet of Warding",  "An enchanted amulet.\n+2 MGC, +2 CON",           "resources/sprites/items/equipment/accessories/amulet_of_warding.png", EQUIP_CAT_ACCESSORY, EQUIP_SLOT_ACCESSORY, 0, 0, 0, 0,0,2,2,0, false, false },
    { EQUIP_BOOTS_OF_SWIFTNESS,"Boots of Swiftness","Light boots that aid movement.\n+3 DEX, +1 CON", "resources/sprites/items/equipment/accessories/boots_of_swiftness.png", EQUIP_CAT_ACCESSORY, EQUIP_SLOT_ACCESSORY, 0, 0, 0, 0,3,0,1,0, false, false },
    { EQUIP_RING_OF_THE_HAWK,  "Ring of the Hawk",   "A hawk's eye in a ring.\n+4 DEX",               "resources/sprites/items/equipment/accessories/ring_of_hawk.png",     EQUIP_CAT_ACCESSORY, EQUIP_SLOT_ACCESSORY, 0, 0, 0, 0,4,0,0,0, false, false },
    { EQUIP_SAGES_PENDANT,     "Sage's Pendant",     "The wisdom of ages.\n+4 MGC",                    "resources/sprites/items/equipment/accessories/sage_pendant.png",     EQUIP_CAT_ACCESSORY, EQUIP_SLOT_ACCESSORY, 0, 0, 0, 0,0,4,0,0, false, false },
    { EQUIP_LUCKY_CHARM,       "Lucky Charm",        "A charm of fortune.\n+6 LCK",                    "resources/sprites/items/equipment/accessories/lucky_charm.png",      EQUIP_CAT_ACCESSORY, EQUIP_SLOT_ACCESSORY, 0, 0, 0, 0,0,0,0,6, false, false },
    { EQUIP_BERSERKER_BAND,    "Berserker Band",     "Strength at a cost.\n+5 STR, -2 DEF",            "resources/sprites/items/equipment/accessories/fallback_ring.png",    EQUIP_CAT_ACCESSORY, EQUIP_SLOT_ACCESSORY, 0, -2, 0, 5,0,0,0,0, false, false },

    // Ranged weapons
    { EQUIP_SIMPLE_BOW,    "Simple Bow",       "A rough hunting bow.\n+3 ATK, +1 DEX\nRange: 4",   "resources/sprites/items/equipment/weapons/simple_bow.png",   EQUIP_CAT_WEAPON, EQUIP_SLOT_WEAPON, 3, 0, 0, 0,1,0,0,0, true, true },
    { EQUIP_DWARVEN_BOW,   "Dwarven Bow",      "A stout dwarven shortbow.\n+5 ATK, +2 DEX\nRange: 5", "resources/sprites/items/equipment/weapons/dwarven_bow.png", EQUIP_CAT_WEAPON, EQUIP_SLOT_WEAPON, 5, 0, 0, 0,2,0,0,0, true, true },
    { EQUIP_ELVEN_BOW,     "Elven Bow",        "A graceful elven longbow.\n+7 ATK, +4 DEX\nRange: 7", "resources/sprites/items/equipment/weapons/elven_bow.png",   EQUIP_CAT_WEAPON, EQUIP_SLOT_WEAPON, 7, 0, 0, 0,4,0,0,0, true, true },
    { EQUIP_GREATBOW,      "Greatbow",         "A massive war bow.\n+10 ATK, +2 DEX\nRange: 8",     "resources/sprites/items/equipment/weapons/greatbow.png",     EQUIP_CAT_WEAPON, EQUIP_SLOT_WEAPON, 10, 0, 0, 0,2,0,0,0, true, true },
    { EQUIP_CROSSBOW,      "Crossbow",         "A mechanical crossbow.\n+8 ATK, +3 DEX\nRange: 6",   "resources/sprites/items/equipment/weapons/crossbow.png",     EQUIP_CAT_WEAPON, EQUIP_SLOT_WEAPON, 8, 0, 0, 0,3,0,0,0, true, true },
};
